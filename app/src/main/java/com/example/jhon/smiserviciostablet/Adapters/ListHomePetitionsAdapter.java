...
public class ListHomePetitionsAdapter extends BaseAdapter {
    ...
    public ListHomePetitionsAdapter(List<Homepetitions> data, Context context, List<Users> dataUser, HomePetitionsInterface homePetitionsInterface, boolean isTaken) {
        this.data = data;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (isTaken) {
            ...
            if (data.get(i).getFechaaceptada() != 0) {
                fechaAceptada.setText(formatFechaAceptada.format(data.get(i).getFechaaceptada()));
            }
        }
